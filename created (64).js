...
const BotUserSchema = new mongoose.Schema({
  ...
  verificationStep: { type: String, default: 'none' }, // Track the current verification step: 'phone', 'location', 'both_phone', 'both_location', or 'none'
});
    ...
    if (update.callback_query) {
      ...
      if (callbackData === 'lang_en') {
        ...
        try {
          ...
          await bot.telegram.sendPhoto(
            chatId,
            'https://ibb.co/BHbSztdG', // Same photo as gallery hack
            {
