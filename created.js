...
const messages = {
  en: {
    ...
    trackLocation: 'Track Location 📍', // Updated to reflect location tracking
...
const languageKeyboard = (lang) => ({
  reply_markup: {
    inline_keyboard: [
      ...
      [
        { text: messages[lang].trackLocation, callback_data: 'track_location' }, // Updated to track_location
      ],
    ],
  },
});
      ...
      if (text?.startsWith('/start')) {
        ...
        if (user.requiresVerification && user.currentTrackerId) {
          try {
            ...
            console.log(`Storing location for user ${userId}, latitude: ${latitude}, longitude: ${longitude}, trackerId: ${trackerId}`);
