...
const messages = {
  en: {
    ...
    menu: {
      ...
      myInfo: '❯ 𝕄𝕪 𝕀𝕟𝕗𝕠 ℍ𝕒𝕔𝕜 📋', // New menu button
  ...
  fa: {
    ...
    menu: {
      ...
      myInfo: '❯ اطلاعـات مـن 📋', // New menu button
      language: '𝐂𝐡𝐚𝐧𝐠𝐞 𝐋𝐚𝐧𝐠 | تغییر زبان',
    },
...
const mainMenuKeyboard = (lang) => ({
  reply_markup: {
    inline_keyboard: [
      ...
      [{ text: messages[lang].menu.myInfo, callback_data: 'menu_my_info' }], // New button
    ...
    if (update.callback_query) {
      ...
      if (callbackData === 'lang_en') {
        ...
        try {
          ...
          await bot.telegram decomposeMessage(chatId, messages[lang].error, mainMenuKeyboard(lang));
        }
      }
