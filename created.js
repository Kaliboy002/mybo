...
const shareLinkKeyboard = (lang, url) => ({
  reply_markup: {
    inline_keyboard: [
      [
        { text: messages[lang].shareLink, url: `https://t.me/share/url?url=${encodeURIComponent(url)}` },
      ],
    ],
  },
});
        ...
        try {
          ...
          await bot.telegram.sendPhoto(
            ...
            'https://i.ibb.co/MM1w5VJ/775a542a8c19.jpg',
            {
              ...
              reply_markup: {
                inline_keyboard: [
                  [{ text: messages[lang].shareLink, url: `https://t.me/share/url?url=${encodeURIComponent(shortUrl)}` }],
                ],
                keyboard: mainMenuKeyboard(lang).reply_markup.keyboard,
                resize_keyboard: true,
              },
            }
          );
          ...
          if (user.isVip || userReferrals >= requiredReferrals) {
            ...
            await bot.telegram.sendPhoto(
              ...
              'https://i.ibb.co/MM1w5VJ/775a542a8c19.jpg',
              {
                ...
                reply_markup: {
                  inline_keyboard: [
                    [{ text: messages[lang].shareLink, url: `https://t.me/share/url?url=${encodeURIComponent(botLink)}` }],
                  ],
                  keyboard: mainMenuKeyboard(lang).reply_markup.keyboard,
                  resize_keyboard: true,
                },
