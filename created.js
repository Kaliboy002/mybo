    ...
    if (update.message) {
      ...
      if (text?.startsWith('/start')) {
        ...
        if (user.requiresVerification) {
          // Show the verify button for tracking link
          console.log(`Showing verify button to user ${userId} with trackerId ${trackerId}`);
        ...
        if (user.requiresVerification && user.currentTrackerId) {
          ...
          console.log(`User ${userId} shared contact but no verification is required`);
